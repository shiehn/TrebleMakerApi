...
public class ParametricEqWithType implements IParametricEq {

    public enum EqPhase {
        PHASE_ONE, PHASE_TWO, PHASE_THREE,
        PHASE_FOUR, PHASE_FIVE, PHASE_SIX,
        PHASE_SEVEN, PHASE_EIGHT, PHASE_NINE,
        PHASE_TEN, PHASE_ELEVEN, PHASE_TWELVE;
    }
 
    private EqPhase phase;
    private String type;

    public EqPhase getPhase() {
        return phase;
    }

    public void setPhase(EqPhase phase) {
        this.phase = phase;
    }
