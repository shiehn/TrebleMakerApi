...
public class NNVolume {
    ...
    public NNVolume(AppConfigs appConfigs, String apiUser, String apiPassword) {
    ...
    public Integer trainArpeggioNetWork(float[] predictionInputs, String serverPort) throws URISyntaxException, IOException, InterruptedException {
        ...
        if (model == null) {
            ...
            IOUtils.copy(httpHelper.getURLConnection("http://localhost:" + serverPort + "/data/volume", apiUser, apiPassword).getInputStream(), out);
