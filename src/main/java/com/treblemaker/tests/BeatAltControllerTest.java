...
public class BeatAltControllerTest {
    ...
    public void setup() {
        ...
        beatAltController = new BeatAltController(analyticsVerticalCustomDalMock, beatLoopsDalMock, harmonicLoopsDalMock, softSynthsDalMock);
    }

    @Test
    public void shouldCreateCorrectHeaders() {

        List<String> csvHeaders = beatAltController.createCSVHeaders();
    ...
    public void shouldAddCorrectHeaders(){
        ...
        sw = beatAltController.addCsvHeader(sw, csvHeaders);
    ...
    public void shouldCreateCorrectRow() throws SQLException {
        ...
        when(resultSetMock.getInt("beat_loop_alt_id")).thenReturn(3);
        ...
        StringWriter sw = new StringWriter();
        sw = beatAltController.appendCSVRow(sw, resultSetMock);

        String outPut = sw.toString();

        Assert.assertEquals("3,0,1,1,0,1,1,1,1,1\n", outPut);
    }
    ...
    public void shouldCreateCorrectPredictRow() throws SQLException {
        ...
        float[] actualResult = beatAltController.createPrdectionRow(
                resultSetMock.getInt("beat_loop_id"),
                resultSetMock.getInt("beat_loop_alt_id"),
        ...
        float[] expectedResult = new float[]{0,1,1,0,1,1,1,1,1};
