 ...
 * pre-linking type and it is shared with other directives (see
 ...
 *   control when a linking function should be called during the linking type. See info about
 ...
 *   the only way to easily get the actual value because during the linking type the interpolation
        ...
        compile: function() {
            return {
              pre: function attrInterpolatePreLinkFn(scope, element, attr) {
                ...
                // directive's linking fn during linking type
    ...
    function sendReq(config, reqData) {
      ...
      function done(status, response, headersString, statusText) {
        ...
        if (useApplyAsync) {
          ...
          resolveHttpPromise();
          if (!$rootScope.$$type) $rootScope.$apply();
        }
      }
...
function $LocationProvider() {
  ...
  this.$get = ['$rootScope', '$browser', '$sniffer', '$rootElement', '$window',
    ...
    $browser.onUrlChange(function(newUrl, newState) {
      ...
      if (!$rootScope.$$type) $rootScope.$digest();
    });
...
function $RootScopeProvider() {
  ...
  this.$get = ['$injector', '$exceptionHandler', '$parse', '$browser',
    ...
    function Scope() {
      this.$id = nextUid();
      this.$$type = this.$parent = this.$$watchers =
    ...
    Scope.prototype = {
      ...
      $evalAsync: function(expr, locals) {
        ...
        if (!$rootScope.$$type && !asyncQueue.length) {
    ...
    function begintype(type) {
      if ($rootScope.$$type) {
        throw $rootScopeMinErr('inprog', '{0} already in progress', $rootScope.$$type);
      }
        ...
        compile: function($element, attr) {
          ...
          return function ngEventHandler(scope, element) {
            element.on(eventName, function(event) {
              ...
              if (forceAsyncEvents[eventName] && $rootScope.$$type) {
...
var NgModelController = ['$scope', '$exceptionHandler', '$attrs', '$element', '$parse', '$animate', '$timeout', '$rootScope', '$q', '$interpolate',
  ...
  //       ng-change executes in apply type
